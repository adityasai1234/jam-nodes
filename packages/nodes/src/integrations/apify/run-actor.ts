 ...
 * ```
 */
export const apifyRunActorNode = defineNode<ApifyRunActorInput, ApifyRunActorOutput>({
    ...
    inputSchema: ApifyRunActorInputSchema as any,
    outputSchema: ApifyRunActorOutputSchema as any,
